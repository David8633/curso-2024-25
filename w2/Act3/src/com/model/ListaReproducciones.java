...
public class ListaReproducciones implements Comparable {
	...
	public int compareTo(Object o) {
		int estado =0;
		for (int i = 0; i< canciones.length&&canciones[i]!=null;i++) {
			estado = canciones[i].getN_reproduciiones()>canciones[i+1].getN_reproduciiones()?+1:-1;
		}
		return estado ;
	}
