...
ALTER TABLE PRUEBA ADD PUESTOPRUEBA VARCHAR(30);
...
--ACTUALIZAR
UPDATE ETAPAS
SET NOMBRE = 'Contrarreloj ' || TO_CHAR(fecha, 'YYYY')
WHERE DISTANCIA < 100;
...
INSERT INTO CICLISTASESPANOLES (NOMBRECICLISTAS, NOMBREEQUIPO)
SELECT NOMBRECICLISTAS, NOMBREEQUIPO
FROM ciclistas
